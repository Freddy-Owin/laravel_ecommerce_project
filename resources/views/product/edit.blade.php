                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <select name="brand_id" id="" class="form-control">
                                    ...
                                    <option value="{{ $item->id }}" {{ $item->id==$product->brand->id ? "selected":"" }}>
                                        {{ $item->name }}
                                    </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <img src="{{ asset('storage/products') }}/{{ $product->image }}" alt="Product Image" id="previewImg" style="max-width:130px;margin-top:20px">
                            </div>
                        </div>
                    </div>
                    <button class="btn btn-primary col-12">Edit Product</button>
                </form>
            </div>
        </div>
    </div>
